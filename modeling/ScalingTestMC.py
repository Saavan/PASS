...
def test_handler(args):
    ...
    out =  testMC.testID(N=args[0], prob_id=args[1], samps=args[2], trials=args[3], temperature=args[4],
...
if __name__ == "__main__":
    ...
    fname = 'ScalingTest_MaxCut_{0}_{1}_{2}'.format(time.strftime("%y%m%d", time.localtime()), model, engine)
